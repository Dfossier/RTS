...
{
    [Serializable]
    public struct CameraBoundariesMargin
    {
        public int upperMargin;
        public int bottomMargin;
    }

    public class CameraBoundariesToTerrainPositions
    {
        private RaycastHitter terrainHitter;
        private Camera mainCamera;
        private readonly CameraBoundariesMargin margin;

        public CameraBoundariesToTerrainPositions(RaycastHitter terrainHitter, Camera mainCamera, CameraBoundariesMargin margin)
        {
            this.terrainHitter = terrainHitter;
        ...
        public TerrainPositionsFromCameraBoundaries Get()
        {
            ...
            TerrainPositionsFromCameraBoundaries terrainPositions = new TerrainPositionsFromCameraBoundaries(
                ...
                terrainHitter.Hit(mainCamera.ScreenPointToRay(new Vector2(0 - margin.bottomMargin, 0 - margin.bottomMargin))),
                terrainHitter.Hit(mainCamera.ScreenPointToRay(new Vector2(Screen.width + margin.bottomMargin, 0 - margin.bottomMargin)))
            );
    ...
    public class TerrainPositionsFromCameraBoundaries
    {
        ...
        private void CalculateContour(IReadOnlyList<Vector2> points)
        {
